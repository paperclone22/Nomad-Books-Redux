...
public class ModTags {
	public static class Blocks {
		...
		private Blocks() {}
		public static final TagKey<Block> IS_AIR_REPLACEABLE =
				createTag("replaceable_to_air");
		public static final TagKey<Block> IS_WATER_REPLACEABLE =
				createTag("replaceable_to_water");
